...
(ref:sup-m-litterbag-synthesis-models-caption) Overview of models computed in this study on synthesized litterbag data. "Decomposition equation" is the equation the models use to describe remaining masses over time for litterbag experiments. Equations for the model components are shown in supporting information \@ref(sup-13).

```{r sup-m-litterbag-synthesis-models, tab.cap="(ref:sup-m-litterbag-synthesis-models-caption)"}
tibble::tibble(
...
(ref:sup-out-sdm-all-models-p1-caption) Measured versus predicted remaining masses in litterbag studies from all models computed in our study. Points are average values and error bars are 95% prediction intervals. For a description of each model, see Tab. \@ref(tab:sup-m-litterbag-synthesis-models).
