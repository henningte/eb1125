...
\codedataavailability{Data and code to reproduce this manuscript are available from \citet{Teickner.2024e}. The data used in this study is derived from \citet{Teickner.2024c}.} %% use this section when having data sets and software code available
